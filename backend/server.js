...
app.post('/api/bookings', (req, res) => {
  ...
  const userMailOptions = {
    ...
    text: `Dear ${name},\n\nThank you for booking on ${dateTime}. We look forward to seeing you soon.\n\nBest regards,\nYour Yoga Studio`
  };
  ...
  const ownerMailOptions = {
    ...
    subject: 'New booking',
    text: `${name} has booked on ${dateTime}.`
  };

  // send confirmation email to the user and notification email to the business owner
